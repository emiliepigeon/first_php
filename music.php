...
<body>
    ...
    <main>   
        ...
        <div>
            <h1 class="hookhp text-uppercase text-center py-3 mb-1 "><strong>la page pour les mélomanes!</strong></h1>
        </div>
        <h2 class="stcategoryhp text-uppercase text-center py-2"><strong>musique</strong></h2>
        <div>
            <h1 class="construction text-uppercase text-center align-items-center py-3 mb-1 ">Page Musique </br>en construction.</br> Merci!</h1>
        </div>
