...
<body>
    ...
    <main>   
        ...
        <div>
            <h1 class="hookhp text-uppercase text-center py-3 mb-1 "><strong>la page amateurs de lecture!</strong></h1>
        </div>
        <h2 class="stcategoryhp text-uppercase text-center py-2"><strong>livres</strong></h2>
        <div>
            <h1 class="construction text-uppercase text-center align-items-center py-3 mb-1 ">Page Livres </br>en construction.</br> Merci!</h1>
        </div>
